...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript" src="/sites/all/modules/xmlsitemap/xsl/jquery.tablesorter.min.js"></script>
        <script type="text/javascript" src="/sites/all/modules/xmlsitemap/xsl/xmlsitemap.xsl.js"></script>
  ...
  <xsl:template name="sitemapTable">
    <div id="information">
      <p>Bu site haritasındaki URL sayısı: <xsl:value-of select="count(sitemap:urlset/sitemap:url)"></xsl:value-of></p>
    </div>
